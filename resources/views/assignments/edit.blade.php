...
@section('content')
    ...
    <h1>{{ $assignments->naam }} bewerken </h1>
    <small>
    ...
    <hr class="sub">
    <form method="POST" class="form-horizontal" action="{{ URL("/assignments/$assignments->id") }}">
        {{ method_field('PATCH') }}
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col col-md-9">
                    <input type="text" class="form-control" id="naamInput"
                           name="naamInput" value="{{ $assignments->naam }}">
                </div>
            </div>
            <div class="row">
                ...
                <div class="col col-md-9">
                    <textarea class="form-control" id="beschrijvingTextArea"
                              name="beschrijvingTextArea" rows="8">{{ $assignments->beschrijving }}</textarea>
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <a href="{{URL::to("assignments/" . $assignments->id)}}">
